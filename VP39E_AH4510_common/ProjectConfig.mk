...
CUSTOM_KERNEL_IMGSENSOR = gc5025_mipi_raw gc2385_mipi_raw gc2386_mipi_raw gc030a_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc5025_mipi_raw gc2386_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc2385_mipi_raw gc030a_mipi_raw
CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TOUCHPANEL = msgdrv_all
CUSTOM_KERNEL_UNCALI_GYRO_SENSOR =
CUSTOM_KERNEL_UNCALI_MAG_SENSOR =
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
#xuyunlai adjust modem 2018-07-30 begin
CUSTOM_MODEM = VP39_AH4510_BAND18_HSPA_CBOFF
#xuyunlai adjust modem 2018-07-30 end
...
#redmine142861 xuyunlai modified for express+ 2018-08-04 begin
MTK_FILEMANAGER_APP = no
#redmine142861 xuyunlai modified for express+ 2018-08-04 end
MTK_FIRST_MD = 1
...
sagereal_target_project = k80hd_bsp_fwv_512m

pcb_config = VP39_AH4510

sagereal_memory_flash  = EMMC_64_4_VP39         # EMMC_32_4 , EMMC_64_8

CUSTOM_KERNEL_RGB_LED = no

CUSTOM_KERNEL_HALL_SUPPORT=no

SAGEREAL_COCLOCK_SUPPORT=yes

sagereal_audio_effect_para = VP39E_AH4510_SYM

sagereal_tp_para= 

sagereal_tee_support = TRUSTKERNEL_TEE_6_20_MT6580

sagereal_tee_cert = Symphony.V48.mt6580

#sagereal_camera_effect_para  = 

sagereal_fat_config = 

sagereal_battery_capacity  =  battery_4200mV_1800mAh_weike
...
#logo,animation
logo_size = fwvga   #wvga qhd hvga fwvga hd

#开关机动画,铃声资源等...
sagereal_customer = Symphony_V48

#默认来电铃声，消息铃声和闹钟铃声,填写资源名称(xxx.mp3)，不允许有空格
SAGEREAL_MULTISIM_RINGTONE = yes #双卡铃声必须打开
#Redmine142164 modify by liujingjing for default ringtone and notification sound 20180730 begin
config_ringtone= Symphony_Ringtone_05.mp3
config_ringtone2= Symphony_Ringtone_05.mp3
config_notification= Cobalt.ogg
#Redmine142164 modify by liujingjing for default ringtone and notification sound 20180730 end

#蓝牙,WLAN名称，不允许出现空格,用“_”代替空格
bluetooth_hostname = V48
wlan_ssid = V48

#默认时区,例Asia/Shanghai(不允许出现空格)
config_timezone = Asia/Dhaka

#在SAGEREAL_CHROMEHOME_APP为yes的情况下修改chrome浏览器的主页，例:www.mobiwire.com 不要出现http：//（已经在脚本上添加）
SAGEREAL_CHROMEHOME_APP = yes     #Chrome主页修改必须保证此宏是开的
default_chrome_homepage = www.symphony-mobile.com

#the space char use "%space%" instead.
SAGEREAL_MODEL_NAME = V48
SAGEREAL_TARGET_DEVICE = V48
SAGEREAL_PRODUCT_NAME = V48
SAGEREAL_PRODUCT_MANUFACTURER = Symphony

#分区大小调整(System, vendor, cache)
BOARD_MTK_SYSTEM_SIZE_KB = 1355776

#老化测试相关宏，释放给客户的请不要打开，内部老化测试软件打开即可
# TECNO_AGINGFUNCTION_SUPPORT = yes
# TRAN_DISABLE_ADB_RSA_SUPPORT = yes
# sagereal_agingtest_enable =  true
...
#redmine124603 xuyunlai add for symphony apk and fota 2018-03-20 begin
MOMAGIC_APPS_SUPPORT = yes
MOMAGIC_FOTA_SUPPORT = yes
#redmine124603 xuyunlai add for symphony apk and fota 2018-03-20 end

#redmine131791 xuyunlai add for my_symphony apk 2018-05-09 begin
MY_SYMPHONY_APPS_SUPPORT = no
#redmine131791 xuyunlai add for my_symphony apk 2018-05-09 end

#redmine127401 xuyunlai modified for factory test 2018-03-24 begin
...
#redmine127401 xuyunlai modified for factory test 2018-03-24 end

#Redmine 112223 liyang modify for add clean button 2017.12.19 begin
sagereal_support_ram_killer=true
#Redmine 112223 liyang modify for add clean button 2017.12.19 end

#Redmine 124581 Display brightness should be full by default modify by licong 20180314 begin
def_screen_brightness = 255
#Redmine 124581 Display brightness should be full by default modify by licong 20180314 end

##Redmine124578 licong add Network bearer icons  2018-03-20 begin
##请同时打开或者关闭3G_PLUS两项，一样的修改仅格式不同,以前开发的就这样使用不再修改了
sagereal_show_3g_plus = false
sagereal_show_h_plus = true ## 请注意不要和3g_plus同时打开
##Redmine124578 licong add Network bearer icons  2018-03-20  end

##Redmine127590 licong modify for Network bearer icons  2018-03-26 begin
config_hspa_data_distinguishable =true
##Redmine127590 licong modify for Network bearer icons  2018-03-26  end

#redmine128513 xuyunlai add soundrecoder 2018-04-05 begin
TECNO_SOUNDRECODER_INSTALL = yes
#redmine128513 xuyunlai add soundrecoder 2018-04-05 begin

#Redmine128860 liujingjing add for auto-rotate on 2018-04-09 begin
def_accelerometer_rotation = false
#Redmine128860 liujingjing add for auto-rotate on 2018-04-09 end

#Redmine128506 liujingjing add for reboot tap 2018-04-09 begin
sagereal_reboot_tapping = true
#Redmine128506 liujingjing add for reboot tap 2018-04-09 end

#Redmine130475 zhujiaming remove transfer call option 2018-4-20 begin
sagereal_remove_transfer_option = true
#Redmine130475 zhujiaming remove transfer call option 2018-4-20 end

#redmine135786 xuyunlai remove play movies 2018-05-29 begin
SAGEREAL_PLAY_MOVIES_INSTALL = no
#redmine135786 xuyunlai remove play movies 2018-05-29 end

#Redmine 114411 qianfeifei remove the navigation bar 2017.12.27 begin
config_showNavigationBar = false
#Redmine 114411 qianfeifei remove the navigation bar 2017.12.27 end

#Redmin124577 liujingjing modified for remove wifi direct 2018-03-13 begin
sagereal_WIFI_LOGO_remove_wifiDirect = true
#Redmin124577 liujingjing modified for remove wifi direct 2018-03-13 end

#Redmine 124602 liujingjing add screen capture when long press of power 2018.03.13 begin
sagereal_vdf_power_key = true
#Redmine 124602 liujingjing add screen capture when long press of power 2018.03.13 end

#Redmine 142189 liujingjing add airplane mode when long press of power 2018.08.07 begin
sagereal_airplane_power_key = true
#Redmine 142189 liujingjing add airplane mode when long press of power 2018.08.07 end

#redmine142539 xuyunlai add for screen fill light 2018-07-26 begin
SAGEREAL_SCREEN_FILL_LIGHT_SUPPORT = yes
#redmine142539 xuyunlai add for screen fill light 2018-07-26 end

#Redmine145040 huangxinxin modify for front camera face beauty mode default on 2018-08-20 beign
SAGEREAL_CAMERA1_DEFAULT_BEAUTY_MODE = yes
#Redmine145040 huangxinxin modify for front camera face beauty mode default on 2018-08-20 end
#=======================================Sagereal MMI end==========================================#
